...
function HeadTrackedCamera() {
  ...
  // 🎛️ YOUR "GOLDEN SETTINGS" DEFAULT VALUES
...
function Loader() {
  return (
    <Html center>
      <div className="text-white font-mono text-sm bg-black/80 p-4 rounded border border-gray-700">
        LOADING SPLAT...
      </div>
    </Html>
  );
...
export default function SpatialViewer() {
  ...
  // 🎛️ STAGE SETTINGS FROM YOUR SCREENSHOT
  ...
  return (
    <div className="w-screen h-screen bg-black">
      ...
      <div className="absolute bottom-4 left-4 text-white font-mono z-10 pointer-events-none opacity-40">
        <p className="text-xs">
            Architecture: Standard R3F | Mode: Head Tracked
        </p>
      </div>
    </div>
  );
